    ...
    useEffect(() => {
        const fetchMember = async () => {
            ...
            try {
                ...
                if (id.startsWith("VS-")) {
                    // For public share page, we also need to filter by status="accepted"
                    const q = query(
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-black text-white">
                <div className="text-center">
                    ...
                    <p className="text-gray-400">The requested member profile does not exist.</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <HelmetProvider>
            <div className="min-h-screen bg-black flex flex-col items-center justify-center p-4 gap-8">
                <Helmet>
                    <title>{member.fullName} | Venture Social Member</title>
                    <meta property="og:title" content={`I am a Member of Venture Social | ${member.fullName}`} />
